...
public class UsuarioController extends GenericController {
    ...
    public ResponseEntity<List<UsuarioDto>> listarUsuarios() {
        return encapsulaResultadoOk(usuarioService::listarUsuarios);
    }
    ...
    public ResponseEntity<UsuarioDto> obterUsuarioPorId(@PathVariable Long id) {
        return encapsulaResultadoOk(() -> usuarioService.obterUsuarioPorId(id));
    }
    ...
    public ResponseEntity<UsuarioDto> deletarUsuario(@PathVariable Long id) {
        return encapsulaResultadoOk(() -> usuarioService.deletarUsuario(id));
    }
}